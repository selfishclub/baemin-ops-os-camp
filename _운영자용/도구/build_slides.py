...
<div class="split">
<div class="on-acid"><p class="head"><strong>공동 저장소</strong><span>교실 겸 공동 작업실 · 10/2까지는 전부 여기</span></p><ul>
...
<div><p class="head"><strong>내 개인 저장소</strong><span>내 창고 · 10/2 중간 점검 때 만듦</span></p><ul>
<li>10/2에 내 폴더의 앱을 <b>옮겨 두는 곳</b></li><li>GitHub과 Vercel을 연결해 push만 하면 자동 배포</li><li>누구나 볼 수 있게 <b>공개(Public)</b></li><li>캠프 끝나도 계속 내 것</li><li>오늘은 안 만들어요</li></ul></div>
</div>
<div class="foot"><p class="note">10/2까지는 만든 폴더를 공동 저장소 내 폴더에 통째로 올려요. 서로 힌트를 얻으려고요. 10/2에 각자 개인 저장소로 흩어지고, 그 주소로 서로 써 봐요.</p></div>"""))
d1.append(S("light", """<p class="eyebrow">그림 한 장</p><h2>10/2까지는 <mark>공동 저장소 내 폴더</mark>, 10/2부터 <mark>내 개인 저장소</mark></h2>
<div class="flowbox">
...
<div class="a">(선택)<br>임시 주소 →</div><div class="n"><b>Vercel</b><span>오늘은 있으면<br>AI가 폴더에서 바로</span></div>
</div>
...
<div><p class="k">④ 제출서.md</p><p class="t">실행 방법</p><p class="d">도구 이름, 한 줄 설명, 실행 방법. Vercel 주소는 있으면.</p></div>
<div><p class="k">⑤ 결과물/</p><p class="t">첫화면.png</p><p class="d">첫 화면 사진은 '구경하기' 표에 올라가요. 폰으로 찍어도 돼요.</p></div>
</div>
<div class="foot"><p class="note">폴더는 "저런 것도 되는구나" 힌트용. 02 폴더 맨 위 '구경하기' 표에 올라가요. 10/2에 각자 개인 저장소로 흩어지고, 그때부터 Vercel 주소로 서로 써 봐요.</p></div>"""))
...
<div><p class="k">4</p><p class="t">push · 제출서</p><p class="d">한 기능 될 때마다 push. 제출서에 실행 방법과 첫화면.png. Vercel 주소는 있으면.</p></div>
</div>
<div class="foot"><p class="note">v1이 일찍 끝나면 v1/프로젝트를 v2/프로젝트로 복사해서 오늘 v2까지 해도 돼요. 개인 저장소·Vercel 연결은 10/2에 다 같이.</p></div>"""))
d3.append(S("", """<p class="eyebrow">제일 중요한 것</p><h2>10/2까지 만든 건 <span class="y">내 폴더 v1/프로젝트</span>에 통째로</h2>
...
<div class="foot"><p class="note">제출서 맨 아래 확인 칸으로 셀프 체크. 오늘 임시 Vercel 주소가 필요하면 AI에게 "이 프로젝트를 Vercel에 배포해 줘, npx vercel로" 한마디.</p></div>"""))
d3.append(S("light", """<p class="eyebrow">10/2 중간 점검 때</p><h2>다 같이 <mark>개인 저장소</mark>로 흩어져요</h2>
<div class="steps">
<div><p class="k">0</p><p class="t">복사해서 옮기기</p><p class="d">내 폴더 v2/프로젝트를 공동 저장소 옆 새 폴더로 복사. 공동 저장소 쪽은 기록으로 남겨요.</p></div>
...
<div class="foot"><p class="note">왜 10/2에? 만드는 동안은 한곳에서 서로 힌트를 얻는 게 더 중요해서요. 그날 서로 Vercel 주소로 써 보고 피드백해요. 순서는 03 폴더 문서에 다 있어요.</p></div>"""))
