...
// 체크카드 결제 (영수증 없는 체크카드 결제 시연용) — 짝이 되는 가짜 매입 영수증은 lib/costing/samplePurchases.ts
rows.push(
  ["2026-09-02", "NH체크 가짜마트", 48600, 0],
  ["2026-09-04", "NH체크 가짜편의점", 9600, 0], // 영수증 없음
  ["2026-09-06", "NH체크 가짜마트", 32400, 0], // 영수증 할인 3,000원 반영
  ["2026-09-08", "NH체크 가짜생활용품", 16000, 0], // 같은 날 취소
  ["2026-09-08", "NH체크 가짜생활용품", -16000, 0],
  ["2026-09-08", "NH체크 가짜생활용품", 10000, 0],
  ["2026-09-09", "NH체크 네이버페이", 76000, 0], // 영수증 두 장의 합
  ["2026-09-12", "NH체크 (주)가짜유통", 61800, 0], // 영수증은 하루 전 날짜
  ["2026-09-13", "NH체크 가짜철물", 15000, 0], // 영수증 없음
  ["2026-09-15", "NH체크 가짜마트", 27900, 0],
  ["2026-09-16", "NH체크 가짜주차", 7000, 0], // 영수증 없음
);
