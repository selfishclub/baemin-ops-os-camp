...
export const MINORS: Record<Major, string[]> = {
  ...
  임대료: ["임대료", "관리비"],
  세금과공과: ["소득세", "부가세", "원천세", "주민세", "공과금", "면허세"], // 원천세 = 알바·직원 급여 신고 때 내는 소득세(지방소득세 특별징수 포함)
...
export const CARD_PRESETS: CardPreset[] = [
  ...
  { id: "card_zeropay", name: "제로페이", keywords: ["제로페이", "간편결제진흥원", "ZEROPAY"] }, // 제로페이 QR(알리페이·위챗 해외결제 포함). 포스 마감정산서에 안 잡히는 별도 단말
];
