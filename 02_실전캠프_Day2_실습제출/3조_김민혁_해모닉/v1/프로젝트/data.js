...
const ROUTINE_VER = 9;   // 9판: 수조·이끼 상태 확인(t18) 월·수·금만 — 2026-09-23   // 8판: 안양점 17:00 입구·계단 불 켜기 추가 — 2026-09-22   // 6판: 안양점 전용 마감 루틴 2개(계단 쓸기 · 찜기 물 배출) 추가 — 2026-09-22 사장님 요청
...
const TEMPLATES = [
  ...
  { id:'t18', slot:'open', time:'12:30', sort:'12:30', title:'수조·이끼 상태 확인', memo:'이끼 · 수온 · 여과기와 산소발생기 작동음 · 물 탁도 · 배관 누수 / 수온계 사진 카톡 전송', role:ROLE_MGR, crit:true, due:'12:30', grace:30, ev:'kakao', note:true, repeat:{ t:'weekly', days:[1, 3, 5] } },   // 월·수·금만 — 사장님 요청 2026-09-23
